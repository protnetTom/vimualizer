...
menus.tooltips = {
    ...
    toggle_tooltips = "Show helps hints when hovering over settings.",
    toggle_easymotion = "System-wide jumping to clickable elements. Hold Shift while clicking to cycle detection aggression (Conservative/Moderate/Aggressive).",
    toggle_ghost = "Fade UI when inactive",
    toggle_trainer = "Vim practice mode to build muscle memory.",
